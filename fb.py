...
def wa():
    os.system('xdg-open https://api.whatsapp.com/send?phone=6281528760064&text=Assalamualaikum')
...
if sandi == 'Z3V3NT33N' and user == 'Haidar Myxos':
